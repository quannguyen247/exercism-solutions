...
proc gameState {deckA deckB starter} {
    # Lá số có cùng ý nghĩa khi kiểm tra loop
    ...
    while {true} {
        ...
        while {$winner eq ""} {
            ...
            while {$penalty > 0} {
                ...
                if {$value > 0} {
                    # Lá đặc biệt mới chuyển lượt trả phạt
        ...
        # Người thắng đưa pile xuống cuối bộ bài
        incr tricks
        if {$winner eq "A"} {
