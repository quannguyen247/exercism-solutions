oo::class create GoBoard {
    ...
    constructor {input} {
        ...
        # Bàn cờ rỗng thì chiều rộng bằng 0
    ...
    method territory {intersection} {
        ...
        # Dùng lại kết quả nếu vùng này đã được quét
        ...
        # Lưu kết quả cho mọi ô trong vùng
        foreach point $points {
            dict set cache $point $area
        }
        
        # Gom các điểm theo chủ sở hữu
    ...
    method territories {} {
        for {set y 0} {$y < $height} {incr y} {
            for {set x 0} {$x < $width} {incr x} {
                ...
                # territory tự cập nhật cache và totals
